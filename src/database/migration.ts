...
import { applicabilityAll, multiplyOperator, uploadScope } from "../constants";
...
export async function addFwdResearchSubsidyPromotion(pg: Knex): Promise<void> {
  if (process.env.NODE_ENV !== "test") {
    await pg<PriceAdjustmentDBResult>(tableNames.priceAdjustment).insert({
      adjustment_applicability: applicabilityAll,
      ...
      adjustment_scope: uploadScope,
      adjustment_operator: multiplyOperator,
